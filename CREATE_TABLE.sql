...
(
    ...
    REGION_NAME       VARCHAR(50) NOT NULL COMMENT '시도',
    REGION_SUBNAME    VARCHAR(50) NOT NULL COMMENT '시군구',
    AVERAGE_AGE       INT NOT NULL COMMENT '평균나이',
...
(
    REGION_CODE       INT NOT NULL COMMENT '지역코드',
    HOSPITAL_NAME     VARCHAR(50) NOT NULL COMMENT '병원이름',
	CONSTRAINT fk_night_hospital FOREIGN KEY (REGION_CODE) REFERENCES tbl_region (REGION_CODE)
...
(
    CANCER_ID         INT NOT NULL AUTO_INCREMENT COMMENT '암ID',
...
(
	...
	ALLOW_SURGERY			  BOOLEAN NOT NULL COMMENT '수술여부',
	CONSTRAINT fk_cancer_hs tbl_regiontbl_cancer_careFOREIGN KEY (HOSPITAL_ID) REFERENCES tbl_cancer_hospital (HOSPITAL_ID),
