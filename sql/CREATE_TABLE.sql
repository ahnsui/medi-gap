...
(
    ...
    LAT               DECIMAL(15, 10) NOT NULL COMMENT 'X좌표',
    LON               DECIMAL(15, 10) NOT NULL COMMENT 'Y좌표',
...
(
    HOSPITAL_ID     INT NOT NULL COMMENT '병원ID',
    CANCER_ID       INT NOT NULL COMMENT '암ID',
    ALLOW_TREATMENT VARCHAR(10) NOT NULL COMMENT '항암치료여부',
    ALLOW_RADIATION VARCHAR(10) NOT NULL COMMENT '방사선치료여부',
    ALLOW_SURGERY   VARCHAR(10) NOT NULL COMMENT '수술 여부',
